...
test.describe('Login Page UI Tests', {tag: '@UI'}, () => {
...
test.describe('Login Page API Tests', {tag: '@API'}, () => {
  ...
  // Test for checking if login page elements are displayed correctly
  test('should display login page elements correctly API', async () => {
  ...
  test('Login with Invalid Credentials API', async () => {
