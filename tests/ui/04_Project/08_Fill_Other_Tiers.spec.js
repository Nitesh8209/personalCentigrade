...
test.describe('After Topic 1 - Fill Remaining Required Fields and Save', { tag: ['@projectForm', '@UI'] }, () => {
...
test.describe('Publish the Project after completed the Tier 1, Tier 2, Tier 3 topic', { tag: ['@projectForm', '@UI'] }, () => {
  let projectsPage;
  let fieldHandler;
  let page;
...
test.describe('Verify the all Fileds are saved', { tag: ['@projectForm', '@UI'] }, () => {
