...
import { actualsData, forecastData, publishProjectData } from '../../data/IntegrationtestData';


test.describe('add data for TIER-2 Actuals fields', () => {
  ...
  actualsData.forEach(({ description, action, uploadFile }) => {
